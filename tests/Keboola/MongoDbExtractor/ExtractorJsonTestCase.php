...
abstract class ExtractorJsonTestCase extends \PHPUnit_Framework_TestCase
{
    protected $path;
    ...
    public function testExportAll()
    {
        ...
        $export = $extractor->export([
            new ExportJson($this->getConfig()['parameters']['db'], $exportParams, $this->path, $exportParams['name']),
        ]);
