                ...
                ->arrayNode('exports')
                    ->prototype('array')
                        ...
                        ->children()
                            ...
                            ->end()
                            // "includeParentInPK" key is intended for "mapping" mode and is ignored in "raw" mode
                            ->booleanNode('includeParentInPK')
                                // FALSE:
                                //   -> PK of sub-document depends ONLY on sub-document content
                                //   -> so same PK is generated for sub-documents with same content,
                                //      but from different parent document
                                //   -> this is legacy/default behaviour
                                // TRUE:
                                //   -> PK of sub-document depends on content AND hash of parent document
                                //   -> so different PK is generated for sub-documents with same content,
                                //      but from different parent document
